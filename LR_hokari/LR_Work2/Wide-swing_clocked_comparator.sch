...
N 520 -480 520 -460 {lab=#net1}
N 620 -480 620 -460 {lab=#net1}
N 400 -510 410 -510 {lab=#net1}
N 400 -460 460 -510 {lab=#net2}
N 460 -510 480 -510 {lab=#net2}
N 260 -480 260 -460 {lab=#net2}
N 360 -480 360 -460 {lab=#net2}
N 260 -460 400 -460 {lab=#net2}
N 360 -460 360 -380 {lab=#net2}
N 520 -460 520 -340 {lab=#net1}
N 360 -380 360 -340 {lab=#net2}
N 360 -280 360 -240 {lab=NR1}
N 520 -280 520 -240 {lab=xxx}
N 520 -80 520 -40 {lab=GND}
N 360 -80 360 -40 {lab=GND}
N 360 -160 360 -140 {lab=NR1}
N 520 -160 520 -140 {lab=xxx}
N 410 -510 420 -510 {lab=#net1}
N 420 -510 480 -460 {lab=#net1}
...
N 360 -310 520 -310 {lab=#net3}
N 480 -460 620 -460 {lab=#net1}
N 360 -40 520 -40 {lab=GND}
N 460 -110 480 -110 {lab=#net2}
N 400 -110 420 -110 {lab=#net1}
...
N -240 -420 520 -420 {lab=#net1}
N -240 -420 -240 -360 {lab=#net1}
N -120 -380 -120 -370 {lab=#net2}
N -120 -380 360 -380 {lab=#net2}
N -360 -400 -360 -360 {lab=#net4}
N -350 -400 0 -400 {lab=#net4}
N 0 -400 0 -360 {lab=#net4}
N -360 -400 -350 -400 {lab=#net4}
N -240 -330 -120 -330 {lab=GND}
N -180 -480 -180 -400 {lab=#net4}
N -120 -370 -120 -360 {lab=#net2}
...
N 520 -240 520 -160 {lab=xxx}
N 360 -360 400 -360 {lab=#net2}
N 400 -360 460 -110 {lab=#net2}
N 480 -360 520 -360 {lab=#net1}
N 420 -110 480 -360 {lab=#net1}
N 0 -300 0 -240 {lab=NR1}
N -360 -300 -360 -180 {lab=xxx}
N 0 -240 360 -240 {lab=NR1}
N -360 -180 520 -180 {lab=xxx}
...
N 520 -420 820 -420 {lab=#net1}
N 360 -380 740 -380 {lab=#net2}
N 740 -380 740 -280 {lab=#net2}
N 740 -280 820 -280 {lab=#net2}
...
C {NMOS_MIN.sym} 560 -310 2 0 {name=M4 model=nch w=6.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
...
C {PMOS_MIN.sym} 480 -510 0 0 {name=M6 model=pch w=19.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
C {NMOS_MIN.sym} 400 -110 2 0 {name=M7 model=nch w=6.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
...
C {code_shown.sym} -540 120 0 0 {name=spice only_toplevel=false value="
...
C {PMOS_MIN.sym} 220 -510 0 0 {name=M3 model=pch w=19.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
C {PMOS_MIN.sym} 40 -330 2 0 {name=M12 model=pch w=19.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
C {PMOS_MIN.sym} -400 -330 0 0 {name=M11 model=pch w=19.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
C {NMOS_MIN.sym} -280 -330 0 0 {name=M9 model=nch w=6.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
C {NMOS_MIN.sym} -80 -330 2 0 {name=M10 model=nch w=6.5u l=0.65u as=0 ps=0 ad=0 pd=0 m=1}
...
C {PMOS_MIN.sym} -220 -510 0 0 {name=M14 model=pch w=19.5u l=1.3u as=0 ps=0 ad=0 pd=0 m=1}
