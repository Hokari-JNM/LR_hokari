...
S {}
E {}
N 660 -420 720 -420 {lab=#net1}
N 660 -280 720 -280 {lab=#net2}
...
N 240 -300 240 -220 {lab=#net3}
N 400 -300 400 -220 {lab=#net4}
N 400 -440 500 -440 {lab=#net1}
N 140 -440 240 -440 {lab=#net2}
N 240 -440 240 -360 {lab=#net2}
...
N 340 -470 360 -470 {lab=#net2}
N 280 -470 300 -470 {lab=#net1}
N 300 -420 400 -420 {lab=#net1}
N 340 -190 360 -190 {lab=#net2}
...
N 240 -400 260 -400 {lab=#net2}
N 320 -400 340 -400 {lab=#net2}
N 260 -400 320 -400 {lab=#net2}
N 300 -470 300 -190 {lab=#net1}
N 340 -470 340 -190 {lab=#net2}
N 400 -420 600 -420 {lab=#net1}
N 340 -400 600 -400 {lab=#net2}
N 600 -420 660 -420 {lab=#net1}
N 600 -400 600 -280 {lab=#net2}
N 600 -280 660 -280 {lab=#net2}
...
C {LR_hokari/LR_Work2/NAND2.sym} 870 -410 0 0 {name=x2}
C {LR_hokari/LR_Work2/NAND2.sym} 870 -290 0 0 {name=x3}
